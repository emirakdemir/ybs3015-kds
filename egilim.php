...
<section>
	...
	<div class="analizler">
		...
		<li><a class="aktif" href="egilim.php">Müşteri Eğilimleri</a></li><br>
...
var myChart2 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Pantolon/Jean Müşteri Eğilimi',
        }
...
var myChart3 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Sweatshirt/Kazak Müşteri Eğilimi',
        }
...
var myChart6 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Mont/Kaban Müşteri Eğilimi',
        }
